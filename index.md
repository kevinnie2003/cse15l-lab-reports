...
4. Try some commands now! Here is an example where I want to enter one of my classmates' directory but got "permission denied". Then I cd to the public directory and listed the files there.<img width="1312" alt="截屏2023-04-05 18 33 40" src="https://user-images.githubusercontent.com/122497019/230250372-7ef9fc62-d8cb-4a2b-a1d1-e5074f30359b.png">
