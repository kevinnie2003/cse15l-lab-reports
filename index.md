...
2. After installing VS Code, you should use your computer to connect remotely. Your account name is available at [here](https://sdacs.ucsd.edu/~icc/index.php). You may want to reset your password, but wait for 15 minutes or so before trying to log in.
3. Open a new terminal in VS Code, enter 
```
ssh cs15lsp23??@ieng6.ucsd.edu
# where "??" is your identical two letter of your account
```
...
4. Try some commands now! Here is an example where I want to enter one of my classmates' directory but got "permission denied". Then I change to the public directory and listed the files there.
